...
def build_model(embedding_layer):
    ...
    question = layers.Conv1D(filters=200, kernel_size=10, activation='relu', name="question", kernel_regularizer=l2(0.0001),kernel_initializer='he_uniform')(question_embedding)
    answer = layers.Conv1D(filters=200, kernel_size=10, activation='relu', name="answer", kernel_regularizer=l2(0.0001),kernel_initializer='he_uniform')(answer_embedding)
